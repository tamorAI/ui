...
import { useIsMobile } from "@tamor/ui/hooks/use-mobile";
  ...
  return (
    <main
      className={cn(
        ...
        "md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2 md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-lg border",
        className,
      )}
